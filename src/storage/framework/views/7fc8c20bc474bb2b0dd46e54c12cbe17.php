...
<body>
    ...
    <div class="resume-shell" x-data="resumeForm(<?php echo e(Js::from($skillCategories)); ?>, <?php echo e(Js::from($teamRoles)); ?>)">
        ...
        <main class="workspace">
            <section class="form-panel">
                ...
                <form method="POST" action="<?php echo e(route('resume.preview')); ?>" x-ref="resumeForm" @submit.prevent>
                    <?php echo csrf_field(); ?>
                    <?php if($errors->any()): ?>
                    ...
                    <div class="form-actions"><button type="button" class="btn btn-secondary"
                            ...
                            @click="download('<?php echo e(route('resume.download.pdf')); ?>')">PDFをダウンロード</button><button
                            type="button" class="btn btn-secondary"
                            @click="download('<?php echo e(route('resume.download.docx')); ?>')">DOCXをダウンロード</button><button
        ...
        <footer class="site-footer">
            <div class="footer-nav">
                <a href="<?php echo e(route('resume.create')); ?>">ホーム (作成)</a>
                <a href="<?php echo e(route('privacy')); ?>">プライバシーポリシー</a>
                <a href="<?php echo e(route('contact')); ?>">お問い合わせ</a>
            </div>
            <p class="copyright">&copy; <?php echo e(date('Y')); ?> Resume Foundry - 登録不要の即時職務経歴書生成システム</p>
        </footer>
    </div>
</body>

</html>
<?php /**PATH /workspaces/LaravelResumeGenerationSystem/src/resources/views/resume/create.blade.php ENDPATH**/ ?>